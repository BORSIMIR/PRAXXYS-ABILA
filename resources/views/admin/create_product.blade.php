...
<div class="main-panel">
  	...
  	<form method="POST" action="{{url('store_product')}}" enctype="multipart/form-data">
  		...
  		<div class="form-group">
  			<label>Name</label><br>
  			<input type="text" style="color: black;"  name="name" class="form-control" placeholder="Write the Name"/ value="{{ old('name')}}">
  			@if($errors->has('name'))
  		...
  		<div class="form-group">
  			...
  			<input type="text" style="color: black;"  name="description"  class="form-control" placeholder="Write the Description"/ value="{{ old('description')}}">
